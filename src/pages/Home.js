...
export default function Home() {
    ...
    useEffect(() => {
        ...
        if (left && right && container) {
            left.onclick = () => container.scrollBy({
                left: -container.offsetWidth,
                behavior: "smooth",
            });
            right.onclick = () => container.scrollBy({
                left: container.offsetWidth,
                behavior: "smooth",
            });
        }
    }, []);
    return (_jsxs("main", { className: "bg-gray-900 text-white font-sans overflow-x-hidden", children: [_jsxs("nav", { className: "fixed top-0 w-full bg-black/50 backdrop-blur-sm text-gray-100 py-10 z-50 flex justify-center items-center gap-8 text-sm md:text-base", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("img", { src: "/images/logo.jpg", alt: "logo", className: "w-10 h-10" }), _jsx("p", { className: "text-1xl font-bold whitespace-nowrap", children: isChinese ? "中国锡器博物馆" : "CHINA PEWTER MUSEUM" })] }), _jsx("a", { href: "#hero", className: "hover:text-red-400 transition whitespace-nowrap min-w-[60px] text-center", children: isChinese ? "首页" : "Home" }), _jsx("a", { href: "#about", className: "hover:text-red-400 transition whitespace-nowrap min-w-[60px] text-center", children: isChinese ? "关于" : "About" }), _jsx("a", { href: "#Exhibitions & Collections", className: "hover:text-red-400 transition whitespace-nowrap min-w-[60px] text-center", children: isChinese ? "展览与收藏" : "Exhibitions & Collections" }), _jsx("a", { href: "#Craft & Culture", className: "hover:text-red-400 transition whitespace-nowrap min-w-[60px] text-center", children: isChinese ? "工艺与文化" : "Craft & Culture" }), _jsx("a", { href: "#Learning & Discovery", className: "hover:text-red-400 transition whitespace-nowrap min-w-[60px] text-center", children: isChinese ? "研学与教育" : "Learning & Discovery" }), _jsx("a", { href: "#Events & Partnerships", className: "hover:text-red-400 transition whitespace-nowrap min-w-[60px] text-center", children: isChinese ? "活动与交流" : "Events & Partnerships" }), _jsx(motion.button, { onClick: () => setIsChinese(!isChinese), className: "bg-red-800 hover:bg-red-700 px-3 py-1 rounded-md text-white text-xs font-medium transition-colors", whileHover: { scale: 1.05 }, whileTap: { scale: 0.95 }, children: isChinese ? "EN" : "中文" })] }), _jsxs("section", { id: "hero", className: "relative h-screen flex items-end justify-start", children: [_jsxs("div", { className: "fixed inset-0 z-0", children: [_jsx("img", { src: "/images/Welcom.png", alt: "Museum Background", className: "w-full h-full object-cover" }), _jsx("div", { className: "absolute inset-0 bg-black/40" })] }), _jsxs("div", { className: "relative z-10 p-10 md:p-20 text-left", children: [_jsx("h1", { className: "text-2xl md:text-4xl font-bold mb-3 leading-snug", children: isChinese ? (_jsxs(_Fragment, { children: [_jsx("span", { className: "text-xl md:text-2xl", children: "\u6B22\u8FCE\u6765\u5230" }), _jsx("br", {}), _jsx("span", { className: "text-2xl md:text-3xl", children: "\u4E2D\u56FD\u9521\u5668\u535A\u7269\u9986" })] })) : (_jsxs(_Fragment, { children: [_jsx("span", { className: "text-xl md:text-2xl", children: "WELCOME TO" }), _jsx("br", {}), _jsx("span", { className: "text-2xl md:text-3xl", children: "CHINA PEWTER MUSEUM" })] })) }), _jsxs("p", { className: "text-lg text-gray-200", children: ["9:30 \u2013 16:30 (", isChinese ? "周一闭馆" : "Closed Mondays", ")"] })] })] }), _jsxs("section", { id: "intro", className: "relative bg-[#0f172a] py-24 px-6 md:px-20 text-center fade z-10", children: [_jsx("h2", { className: "text-lg md:text-2xl font-bold text-white mb-6 leading-snug", children: isChinese
                            ? "让金属有温度，让文化会呼吸"
                            : "Where Metal Breathes and Culture Lives" }), _jsx("div", { className: "max-w-4xl mx-auto text-gray-300 leading-relaxed space-y-4 text-sm", children: _jsx("p", { children: isChinese
                                ...
                                : "Amid the alleys and waterways of Lili Ancient Town, a Ming Dynasty mansion stands—serene as pewter, timeless as poetry. Here, the China Pewter Museum breathes new life into craft and heritage. This is not a hall of silent objects, but a living dialogue between people and things, between touch and time." }) })] }), _jsx("div", { className: "relative z-10 bg-[#0f172a]", children: _jsxs("section", { id: "about", className: "bg-[#0f172a] text-white py-24 px-6 md:px-20 grid md:grid-cols-2 gap-12 items-center fade", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-2xl md:text-3xl font-bold mb-6 leading-snug", children: isChinese ? "关于博物馆" : "About the Museum" }), _jsx("p", { className: "text-gray-300 leading-relaxed text-lg mb-4 whitespace-pre-line", children: isChinese
...
Its mission is to let pewter culture come alive, be passed on, and reach the wider world — to let metal hold warmth, and culture breathe.` })] }), _jsxs("div", { className: "grid grid-cols-2 gap-4", children: [_jsx("img", { src: "/images/about/about1.jpg", alt: "about1", className: "rounded-lg shadow-md object-cover w-full h-48 md:h-60" }), _jsx("img", { src: "/images/about/about2.jpg", alt: "about2", className: "rounded-lg shadow-md object-cover w-full h-48 md:h-60" }), _jsx("img", { src: "/images/about/about3.jpg", alt: "about3", className: "rounded-lg shadow-md object-cover w-full h-48 md:h-60" }), _jsx("img", { src: "/images/about/about4.jpg", alt: "about4", className: "rounded-lg shadow-md object-cover w-full h-48 md:h-60" })] })] }) }), _jsx("div", { className: "relative z-10 bg-[#0f172a]", children: _jsxs("section", { id: "Exhibitions & Collections", className: "bg-[#0f172a] text-white py-24 px-4 md:px-10 text-center fade", children: [_jsx("h2", { className: "text-2xl md:text-3xl font-bold mb-6 leading-snug", children: isChinese ? "展览与收藏" : "Exhibitions & Collections" }), _jsx("div", { className: "max-w-4xl mx-auto text-gray-300 leading-relaxed text-lg mb-16 whitespace-pre-line", children: _jsx("p", { children: isChinese
...
Every object in the gallery carries its own story. In the play of light and shadow, pewter continues to speak, its sheen holding the warmth of life and the memory of time.` }) }), _jsxs("div", { className: "relative max-w-[1600px] mx-auto", children: [_jsx("button", { id: "scrollLeft", className: "absolute left-0 top-1/2 -translate-y-1/2 bg-gradient-to-r from-[#000000b0] to-transparent text-white p-5 rounded-full z-30 hover:scale-110 transition duration-300", children: "\u2039" }), _jsx("button", { id: "scrollRight", className: "absolute right-0 top-1/2 -translate-y-1/2 bg-gradient-to-l from-[#000000b0] to-transparent text-white p-5 rounded-full z-30 hover:scale-110 transition duration-300", children: "\u203A" }), _jsx("div", { id: "scrollContainer", className: "grid grid-flow-col auto-cols-[90%] sm:auto-cols-[48%] md:auto-cols-[23%] overflow-x-auto scroll-smooth gap-8 px-4 md:px-6 pb-4 hide-scrollbar snap-x snap-mandatory", children: [
                                        {
                                            id: 1,
                                    ...
                                    ].map((item) => (_jsxs("a", { href: `/collections/${item.id}`, className: "bg-[#13203b] hover:bg-[#182a4d] transition-all duration-300 shadow-lg rounded-lg snap-start", children: [_jsx("div", { className: "h-64 overflow-hidden", children: _jsx("img", { src: item.img, alt: item.title, className: "w-full h-full object-cover transition-transform duration-500 hover:scale-105" }) }), _jsxs("div", { className: "text-left p-6", children: [_jsx("h3", { className: "text-xl font-bold mb-3", children: item.title }), _jsx("p", { className: "text-gray-300 text-sm leading-relaxed", children: item.desc })] })] }, item.id))) })] }), _jsx("style", { children: `
            .hide-scrollbar::-webkit-scrollbar { display: none; }
            .hide-scrollbar { -ms-overflow-style: none; scrollbar-width: none; }
          ` })] }) }), _jsx("div", { className: "relative z-10 bg-[#0f172a]", children: _jsxs("section", { id: "Craft & Culture", className: "bg-[#0f172a] text-white py-24 px-6 md:px-20 text-center fade", children: [_jsx("h2", { className: "text-2xl md:text-3xl font-bold mb-6 leading-snug", children: isChinese ? "工艺与文化" : "Craft & Culture" }), _jsxs("div", { className: "max-w-4xl mx-auto text-gray-300 leading-relaxed text-lg mb-16 text-left space-y-6", children: [_jsx("p", { children: isChinese
                                        ? "锡，柔而不弱，润而不寒，素光含静气。在它的延展与回收之间，蕴藏着金属最温柔的秩序。自古以来，锡被视为调和之材——既能与铜成青，又能与银共白，在火与手的交替中，显露出东方文化中“中和”之美。"
                                        : "Pewter is soft yet enduring, gentle yet firm — its muted glow carrying the quiet spirit of balance. For centuries, it has been known as a metal of harmony, blending with copper to form bronze or with silver to yield light brilliance — a reflection of the Eastern pursuit of balance between strength and grace." }), _jsx("p", { children: isChinese
                                        ? "制锡之道，不止于技。冶炼、浇铸、锤打、焊接、打磨、抛光，每一道工序，都是人与物的对话：力量、节奏与心性的平衡。打锡之人，在敲击的回声中体会静气；观锡之人，在光泽的流转中感受时间。工艺的意义，在于以形入心，以物见道。"
                                        : "The making of pewter is more than skill — it is a dialogue between hand and material, between strength, rhythm, and patience. The craftsman listens through the hammer’s rhythm, and the viewer feels through the shifting glow. Here, technique becomes meditation, and form leads to insight." })] }), _jsxs("div", { className: "max-w-6xl mx-auto text-white text-center mt-16", children: [_jsx("h3", { className: "text-2xl font-bold mb-8", children: isChinese ? "传统打锡工艺流程" : "Traditional Pewter Craft Process" }), _jsx("div", { className: "flex flex-wrap justify-center items-center gap-4 text-base md:text-lg leading-relaxed", children: (isChinese
                                        ? [
                                            "原料锡",
                                            "熔锡",
                                            "压锡片",
                                        ...
                                        : [
                                            ...
                                            "Cleaning",
                                            "Decoration",
                                        ]).map((step, index, arr) => (_jsxs(React.Fragment, { children: [_jsx("div", { className: "bg-[#1e2a45] px-4 py-3 rounded-md shadow-md whitespace-nowrap hover:scale-105 transition-all duration-300", children: step }), index < arr.length - 1 && (_jsx("span", { className: "text-gray-400 text-2xl", children: "\u2192" }))] }, index))) })] }), _jsx("div", { className: "max-w-6xl mx-auto my-16", children: _jsx("img", { src: "/images/process.jpg" // 请将“传统打锡工艺流程.jpg”重命名为 process.jpg 并放入 public/images
                                , alt: "Traditional Pewter Craft Process", className: "rounded-lg shadow-lg mx-auto" }) }), _jsx("div", { className: "max-w-6xl mx-auto text-white italic leading-relaxed text-center", children: _jsx("p", { children: isChinese
                                    ? "每一次锤击，都是对时间的回应；每一道光泽，都是对心性的修炼。传统工艺让金属拥有了生命，也让人心找到安处。"
                                    : "Each strike of the hammer answers the call of time; each sheen polished reflects the discipline of the heart. Traditional craftsmanship breathes life into metal — and stillness into the maker’s soul." }) })] }) }), _jsx("div", { className: "relative z-10 bg-[#0f172a]", children: _jsxs("section", { id: "Learning & Discovery", className: "bg-[#0f172a] text-white py-24 px-6 md:px-20 text-center fade", children: [_jsx("h2", { className: "text-2xl md:text-3xl font-bold mb-6 leading-snug", children: isChinese ? "研学与教育" : "Learning & Discovery" }), _jsxs("div", { className: "max-w-4xl mx-auto text-gray-300 leading-relaxed text-lg mb-16 text-left space-y-6", children: [_jsx("p", { children: isChinese
                                        ? "如果说展厅是静观的课堂，工坊便是动手的学堂。中国锡器博物馆将传统工艺教育融入日常体验，让观众在‘做中学’、在‘造中悟’。每一次触摸锡片的温度、聆听锤击的节奏，都是一次从感官到心性的修行。"
                                        : "If the exhibition hall is a classroom for contemplation, the workshop is one for creation. The China Pewter Museum brings traditional craft education into everyday experience—where visitors learn by doing and reflect by making. Each touch of warm pewter, each rhythm of hammering, becomes a meditation in motion." }), _jsx("p", { children: isChinese
                                        ? "博物馆在‘研学4.0’理念下，将金属工艺、文化叙事与创造性思维结合，面向青少年、家庭与国际访客推出多层次课程体系。通过亲手打锡、模具设计、器物拓印等体验活动，学习者在实践中理解工艺之理，感受文化之魂。"
                                        : "Under the ‘Learning 4.0’ initiative, the museum integrates metalwork, storytelling, and creative thinking into a layered education system for students, families, and international visitors. Through hands-on experiences—pewter hammering, mold design, and relief printing—learners grasp not only the technique, but the spirit of craftsmanship." }), _jsx("p", { children: isChinese
                                        ? "我们相信，文化的学习不止是知识的传递，更是心灵的唤醒。无论是儿童的第一次敲打，还是匠人的一次讲解，都是文化生命延续的节点。"
                                        : "We believe that learning culture is not merely the transfer of knowledge, but the awakening of awareness. Whether it is a child’s first hammer strike or a craftsman’s gentle demonstration, each moment becomes part of culture’s living continuity." })] }), _jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-16", children: [
                                {
                                    id: 1,
                            ...
                            ].map((item) => (_jsxs("div", { className: "group bg-[#13203b] hover:bg-[#1a2c4d] rounded-lg overflow-hidden shadow-lg transition-all duration-500 hover:-translate-y-1", children: [_jsxs("div", { className: "relative", children: [_jsx("img", { src: item.img, alt: item.title, className: "w-full h-64 object-cover group-hover:scale-105 transition-transform duration-700" }), _jsx("div", { className: "absolute inset-0 bg-black/30 group-hover:bg-black/40 transition duration-500" })] }), _jsxs("div", { className: "p-6 text-left", children: [_jsx("h3", { className: "text-xl font-semibold mb-3 text-white group-hover:text-red-400 transition-colors duration-500", children: item.title }), _jsx("p", { className: "text-gray-300 text-sm leading-snug", children: item.desc })] })] }, item.id))) }), _jsx("div", { className: "max-w-4xl mx-auto text-gray-400 italic leading-relaxed text-center", children: _jsx("p", { children: isChinese
                                    ? "学习的终点，不是记忆，而是发现。唯有亲手触摸文化，方能真正理解文化的温度。"
                                    : "The goal of learning is not memory, but discovery. Only through touch can we truly understand the warmth of culture." }) })] }) }), _jsxs("div", { className: "relative z-10 bg-[#0f172a]", children: [_jsxs("section", { id: "Events & Partnerships", className: "bg-[#0f172a] text-white py-24 px-6 md:px-20 text-center fade", children: [_jsx("h2", { className: "text-2xl md:text-3xl font-bold mb-6 leading-snug", children: isChinese ? "活动与交流" : "Events & Partnerships" }), _jsxs("div", { className: "max-w-4xl mx-auto text-gray-300 leading-relaxed text-lg mb-2", children: [_jsx("p", { className: "mb-6", children: isChinese
                                            ...
                                            : "From regional summits to international fairs, the museum brings the story of Chinese pewter to the world—bridging traditions with dialogue, and craft with innovation." }), _jsxs("ul", { className: "text-left list-disc list-inside space-y-2 text-gray-400 mx-auto max-w-2xl", children: [_jsx("li", { children: isChinese
                                                    ...
                                                    ? "中国道口锡器文化节"
                                                    : "China Daokou Tinware Cultural Festival" })] }), _jsx("p", { className: "mt-8 text-gray-300", children: isChinese
